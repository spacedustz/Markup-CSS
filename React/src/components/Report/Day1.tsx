    ...
    return (
        <Day1Style>
            ...
            <div className="margin-space">
                <h3 className="title-border">{dayInfo.subTitle[0]}</h3>
                <ul>
                    {dayInfo.favoriteFood.map((food: string) => (
                        <li>{food}</li>
                        )
            ...
            <div className="margin-space">
                <h3 className="title-border">{dayInfo.subTitle[1]}</h3>
                <img
                ...
                <a href="https://github.com/spacedustz">My Github</a>
            </div>

            <div className="margin-space">
                <h3 className="title-border">{dayInfo.subTitle[2]}</h3>
            ...
            <div className="margin-space">
                <h3 className="title-border">{dayInfo.subTitle[3]}</h3>
                <table>
            ...
            <div className="margin-space">
                <h3 className="title-border">{dayInfo.subTitle[4]}</h3>
